...
public class Impact1 : MonoBehaviour
{
    ...
    void Update()
    {
        if (Kin == true || Imapct1Trigger.TriggerTrue == true)
        {
            Invoke("Trigger", 0f);
        ...
        if (isdead == true)//если переменная положительная, то запускаем таймер 
        {
